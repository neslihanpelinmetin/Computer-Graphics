...
window.onload = function init() {
  ...
  // Calculate the aspect ratio using clientWidth and clientHeight
  var aspect = canvas.clientWidth / canvas.clientHeight;

  // Use the calculated aspect ratio in the perspective call
...
function render() {
   ...
   // Update the model-view matrix for the entire scene (e.g., before drawing the axes)
